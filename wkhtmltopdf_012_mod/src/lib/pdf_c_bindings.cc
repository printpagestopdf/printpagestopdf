 ...
 * - \b load.replaceBody replace body by file contents
 * - \b load.localIframe searching for iframes load from local file
 * - \b load.loadTimeout Cancels pageload after (x)ms
 *
 ...
 * - \b guessPageLength Try to set page length to webpage length? Must be either "true" or "false".
