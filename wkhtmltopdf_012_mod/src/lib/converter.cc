...
void ConverterPrivate::updateWebSettings(QWebSettings * ws, const settings::Web & s) const {
	...
	ws->setAttribute(QWebSettings::JavascriptCanCloseWindows, false);
	...
	//RR
	//ws->setAttribute(QWebSettings::FrameFlatteningEnabled,true);
	...
	ws->setAttribute(QWebSettings::XSSAuditingEnabled,false);
